...
class ApiClient {
   ...
   * @param {string | undefined} product_id
   */
  async createLivestream(title, description, product_id) {
  ...
  /**
   * Fetch vendor livestreams, optionally filtered by product id
   * @param {string | undefined} product_id
   */
  async getVendorLivestreams(product_id) {
